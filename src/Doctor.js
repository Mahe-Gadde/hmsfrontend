...
const DoctorForm = () => {
  ...
  const fetchDoctors = async () => {
    try {
      const response = await axios.get(`http://hospitalmanagement-env.eba-p9txdymv.eu-north-1.elasticbeanstalk.com/doctors`);
  ...
  const handleSubmit = async (index) => {
    try {
      await axios.post(`http://hospitalmanagement-env.eba-p9txdymv.eu-north-1.elasticbeanstalk.com/doctors`, doctorData);
  ...
  const handleDeleteDoctor = async (doctorId) => {
    try {
      await axios.delete(`http://hospitalmanagement-env.eba-p9txdymv.eu-north-1.elasticbeanstalk.com/doctors/${doctorId}`);
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      if (editingIndex !== null) {
        ...
        const response = await axios.post(`http://hospitalmanagement-env.eba-p9txdymv.eu-north-1.elasticbeanstalk.com/doctors`, doctorData);
